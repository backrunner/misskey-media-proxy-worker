// Runtime types generated with workerd@1.20240925.0 2023-09-18 nodejs_compat
/*! *****************************************************************************
 ...
 */
declare class Request<CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>> extends Body {
...
declare class URLSearchParams {
    constructor(param0?: (Iterable<Iterable<string>> | Record<string, string> | string));
...
declare namespace Rpc {
    ...
    export type EntrypointBranded = WorkerEntrypointBranded | DurableObjectBranded | WorkflowBranded;
    ...
    // Structured cloneable composites
     | Map<Serializable, Serializable> | Set<Serializable> | ReadonlyArray<Serializable> | {
    ...
    // prettier-ignore
    type Result<R> = R extends Stubable ? Promise<Stub<R>> & Provider<R> : R extends Serializable ? Promise<Stubify<R> & MaybeDisposable<R>> & MaybeProvider<R> : never;
...
declare module "cloudflare:workers" {
    ...
    export type WorkflowStep = {
        do: <T extends Rpc.Serializable>(name: string, callback: () => Promise<T>, config?: WorkflowStepConfig) => Promise<T>;
        sleep: (name: string, duration: WorkflowSleepDuration) => void | Promise<void>;
    };
    export abstract class Workflow<Env = unknown, T extends Rpc.Serializable | unknown = unknown> implements Rpc.WorkflowBranded {
...
type InstanceStatus = {
    status: "queued" | "running" | "paused" | "errored" | "terminated" | "complete" | "unknown";
    error?: string;
    output?: object;
};
